...
let math1 = +prompt("Misolni Yeching: 6 + 3 = ?");

let math2 = +prompt("Misolni Yeching: 20 - 5 = ?");

let math3 = +prompt("Misolni Yeching: 15 * 2 = ?");

let math4 = +prompt("Misolni Yeching: 8 / 4 = ?");

let math5 = +prompt("Misolni Yeching 10 % 3 = ?");
